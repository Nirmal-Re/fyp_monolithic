...
const getUserIDByEmail = async (email) => {
    return await (0, db_1.getItemsByCriteria)('t_user_login_data', ["id"], { email });
};
exports.getUserIDByEmail = getUserIDByEmail;
const getUserDataByEmail = async (email) => {
    return await (0, db_1.getItemsByCriteria)('t_user_login_data', ["id", "first_name", "last_name", "hashed_password"], { email });
};
exports.getUserDataByEmail = getUserDataByEmail;
const getUserByUsername = (username) => {
    (0, db_1.getItemsByCriteria)('t_user_login_data', ["id"], { username });
};
...
const deleteUserByID = async (user_id) => {
    return await (0, db_1.deleteItemByID)('t_user_login_data', user_id);
};
exports.deleteUserByID = deleteUserByID;
const updateUserByID = async (id, changes) => {
    return await (0, db_1.updateItem)('t_user_login_data', id, changes);
};
